...
public class Driver {
    public static void main(String[] args) {
        ...
        HashMap<Integer[], Integer> randomSortedArrays = randomArrays;
        ...
        ArrayList<IGenericSort<Integer>> sorts = new ArrayList<>(); // TODO: Agregar Cycle y Quicksort
        ...
        for (IGenericSort<Integer> sort : sorts) {
            ...
            for (Integer[] array : randomArrays.keySet()) {
                ...
                System.out.println("Tiempo transcurrido en segundos: " + profiler(sort.getClass().getSimpleName(), new Runnable() {
                    @Override
                    public void run() {
                        sort.sort(array);
                    }
    ...
    public static double profiler(String name, Runnable runnable) {
        long startTime = System.nanoTime();
        runnable.run();
        long endTime = System.nanoTime();
        return (endTime - startTime) / Math.pow(10,9); // retorna en segundos el tiempo (x10^9)
    }
}
